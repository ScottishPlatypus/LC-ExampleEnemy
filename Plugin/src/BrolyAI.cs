...
#pragma warning restore 0649
        ...
        public override void DoAIInterval() {
            ...
            switch (currentBehaviourStateIndex) {
                ...
                case (int)State.ChasePlayer:
                    ...
                    if (!TargetClosestPlayerInAnyCase() || (Vector3.Distance(transform.position, targetPlayer.transform.position) > 12 && !CheckLineOfSightForPosition(targetPlayer.transform.position))) {
        ...
        IEnumerator AttackPlayer() {
            ...
            while (isInterrupted == false)
            {
                ...
                if (hitCount == 12 || attackedPlayer.isPlayerDead || isInterrupted == true)
                    break;
            ...
            {
                attackedPlayer.causeOfDeath = CauseOfDeath.Suffocation;
                DragPlayerClientRpc();
            }

...
namespace CustomEnnemies {
    ...
    public class Plugin : BaseUnityPlugin {
        ...
        private void Awake() {
            ...
            var bundleName = "modassets_randy";
            ...
            var Randy = ModAssets.LoadAsset<EnemyType>("RandyOrton");
            var RandyTN = ModAssets.LoadAsset<TerminalNode>("RandyOrtonTN");
            var RandyTK = ModAssets.LoadAsset<TerminalKeyword>("RandyOrtonTK");

            // Optionally, we can list which levels we want to add our enemy to, while also specifying the spawn weight for each.
            var RandyLevelRarities = new Dictionary<Levels.LevelTypes, int> {
            ...
            NetworkPrefabs.RegisterNetworkPrefab(Randy.enemyPrefab);
            ...
            Enemies.RegisterEnemy(Randy, RandyLevelRarities, null, RandyTN, RandyTK);

            Logger.LogInfo($"Plugin {PluginInfo.PLUGIN_GUID} is loaded out of nowhere!");
        }
